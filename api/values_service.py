  ...
  if ERMAX > pmaxid:
    book=dbSelect("select sp.propertyname, rates.* from smartproperties sp join "
                ...
                "on CASE WHEN rates.protocol1='Fiat' "
                  ...
                  "ELSE rates.propertyid2=sp.propertyid and (sp.protocol='Omni' or sp.protocol='ElectraProtocol') END")
  return book,ERMAX
...
def getCurrentPriceRaw(input):
  ...
  if input[:2].upper() == "SP":
    protocol1='ElectraProtocol'
    pid1=getPropertyid('XEP', protocol1)
    protocol2 = 'Omni'
    ...
    protocol2='ElectraProtocol'
    pid2=getPropertyid('XEP', protocol2)
